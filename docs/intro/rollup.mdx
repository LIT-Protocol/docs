...
To obtain the `LIT` test token, please use the faucet at https://faucet.litprotocol.com/. The `LIT` test token will be sent to your wallet address, allowing you to perform test transactions on the rollup.
...
Now that you've learned about Chronicle, you can write your first Lit Action that uses a PKP to sign! Learn how to do that [here](../lit-actions/intro).

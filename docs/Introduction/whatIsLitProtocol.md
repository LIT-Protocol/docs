...
PKPs are the public/private key pairs generated by the Lit network and are minted in the form of an ERC-721 NFT. Only the owner of the NFT can combine the underlying key shares and form the complete signature. 

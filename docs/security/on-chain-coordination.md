...
All Lit node operators also run a replica node for the Orbit chain (also inside of the TEE), ensuring Lit’s on and off-chain operations remain tightly synchronized.

...
- `authMethodType`: A number representing the type of auth method you want to add. Refer to the supported auth methods table [here](../../pkp/authHelpers/overview#existing-supported-auth-methods).
...
- `authMethodType`: A number representing the type of auth method you want to remove. Refer to the supported auth methods table [here](../../pkp/authHelpers/overview#existing-supported-auth-methods).

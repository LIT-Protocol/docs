...
This guide covers the installation of the `@lit-protocol/lit-node-client` package, which can be used in both browser and Node.js environments.

## Installion with npm or Yarn
<Tabs
defaultValue="npm"
values={[
{label: 'npm', value: 'npm'},

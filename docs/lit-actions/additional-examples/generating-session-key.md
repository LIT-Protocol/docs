...
This [example](https://github.com/LIT-Protocol/js-serverless-function-test/blob/main/js-sdkTests/sessionKeys.js) demonstrates how to generate a signed [session key](../../sdk/explanation/authentication/session-sigs/intro) using Lit Actions.
